...
.. important::
   ...
   Due to the nature of academia, DRIVE has to maintain moderate backwards compatibility and be very explicit when backwards compatibility is broken. For this reason all DRIVE code has to use syntax compatible with the oldest acceptable version of Python. Sometimes this means very helpful updated language features can't be used. We ask that whenever any contributions that break backwards compatibility are introduced, you explicitly mention how it is breaking compatibility and you use appropriate versioning to indicate the change.
